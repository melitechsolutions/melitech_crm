...
const troubleshootingGuides: TroubleshootingItem[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "If still failing, contact support@melitech.com",
    ],
...
export default function TroubleshootingGuide() {
  ...
  return (
    <ModuleLayout
      ...
      description="Find solutions to common issues and learn best practices"
          ...
          <CardContent>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Button variant="default" className="w-full" asChild>
                <a href="mailto:support@melitech.com" className="flex items-center gap-2">
