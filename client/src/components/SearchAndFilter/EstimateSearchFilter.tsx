...
interface EstimateSearchFilterProps {
  onSearch: (query: string) => void;
  onFilter: (filters: EstimateFilters) => void;
  isLoading?: boolean;
}

export interface EstimateFilters {
  status?: "draft" | "sent" | "accepted" | "rejected" | "expired" | "all";
  sortBy?: "number" | "date" | "amount" | "expiryDate";
  sortOrder?: "asc" | "desc";
}

export function EstimateSearchFilter({
  onSearch,
  onFilter,
  isLoading = false,
}: EstimateSearchFilterProps) {
  ...
  const handleFilterChange = useCallback(
    (key: keyof EstimateFilters, value: string) => {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="number">Estimate Number</SelectItem>
